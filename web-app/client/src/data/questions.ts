...
export const uiStrings: Record<Language, Record<string, string>> = {
  tr: {
    ...
    testCount: "3 Test",
    preparedFor: "Reflektif.net Kariyer Yönlendirme Platformu",
    ...
    contact: "İletişim",
    footerPrepared: "Reflektif.net — Bilimsel temelli kariyer yönlendirme platformu",
  ...
  fr: {
    ...
    testCount: "3 Tests",
    preparedFor: "Plateforme d'Orientation de Carrière Reflektif.net",
    ...
    contact: "Contact",
    footerPrepared: "Reflektif.net — Plateforme d'orientation de carrière basée sur la science",
  ...
  en: {
    ...
    questionCount: "110 Questions",
    testCount: "3 Tests",
    preparedFor: "Reflektif.net Career Guidance Platform",
    heroTitle1: "Reflektif Test",
    ...
    contact: "Contact",
    footerPrepared: "Reflektif.net — Science-based career guidance platform",
